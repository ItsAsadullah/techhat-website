            ...
            <div class="px-8 py-6">
                ...
                <form method="POST" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" class="w-4 h-4 accent-pink-600 rounded">
                            <span class="text-gray-600">Remember me</span>
                        </label>
                        <a href="#" class="text-pink-600 font-semibold hover:text-pink-700">
                            Forgot password?
                        </a>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="register.php" class="text-pink-600 font-bold hover:text-pink-700 ml-1">
                            Sign Up
                        </a>
                    </p>
                </div>
                ...
                <p class="text-xs text-gray-500 text-center mt-6 leading-relaxed">
                    By continuing, you agree to TechHat's 
                    <a href="#" class="text-pink-600 hover:underline">Terms of Use</a> and 
